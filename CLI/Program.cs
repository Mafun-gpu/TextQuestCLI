            ...
            switch (currentGame.state)
            {
                ...
                case CLIState.GameInventoryPage:
                    ...
                    if (inventoryChoice == 0)
                        currentGame.ProcessInput(null);
                    else if (inventoryChoice >= 0 && inventoryChoice < i)
                    {
                        Console.Clear();
                ...
                case CLIState.GameStorePage:
                    ...
                    if (itemChoice == 0)
                        currentGame.ProcessInput(null);
                    else if (itemChoice >= 0 && itemChoice < ii)
                    {
                        Console.Clear();
                ...
                case CLIState.GameActivityPage:
                    ...
                    if (questChoice == 0)
                        currentGame.ProcessInput(null);
                    else if (questChoice >= 0 && questChoice < ii)
                    {
                        Console.Clear();
                ...
                case CLIState.Exit:
                    ...
                    if (saveGame == 1)
                    {
                        ...
                        Func<string?, bool> isValid = filename =>
                            !string.IsNullOrEmpty(filename) &&
                            filename.IndexOfAny(Path.GetInvalidFileNameChars()) < 0;
                        string? saveName = Console.ReadLine();

                        while (!isValid(saveName))
                        {
                            Console.Clear();
                            Console.WriteLine($"Сохранить игру?");
                            Console.WriteLine($"-------");
                            Console.Write("[Сохранить]>[Название сохранения (ВВЕДИТЕ ВАЛИДНОЕ ИМЯ)]> ");
